...
var colors = {
  "Asia": [28,100,52],
  "North America": [318,65,67],
  "Africa": [10,30,42],
  "South America": [359,69,49],
  "Europe": [204,70,41],
  "Oceania": [120,56,40]
};
...
function selectWave() {
  ...
  if (selectionValue !== undefined && selectionValue !== activeWave) {
    ...
    var activeWaveText = document.getElementById("selected-wave-hl");
    let partWaveText = "Selected wave is: ";
    var waveToLoad = "-confidence.csv";

    if (selectionValue == 'wave3'){
      activeWaveText.innerHTML = partWaveText + "Wave 3 (1995-1999)";
      waveToLoad = selectionValue + waveToLoad;
    }
    else if (selectionValue == 'wave4'){
      activeWaveText.innerHTML = partWaveText + "Wave 4 (2000-2004)";
      waveToLoad = selectionValue + waveToLoad;
    }
    else if (selectionValue == 'wave5'){
      activeWaveText.innerHTML = partWaveText + "Wave 5 (2005-2009)";
      waveToLoad = selectionValue + waveToLoad;
    }
    else {
